...
export default function SupportPage() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        setSent("error");
        setServerMsg(data?.error || "Impossible d’envoyer le ticket pour le moment.");
        return;
      }
          ...
          <div className="flex items-start justify-between gap-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-300/80 max-w-2xl">
                ...
                Envoie-nous un ticket — on reçoit tout sur{" "}
                <span className="text-slate-100 font-medium">contact@mind-link.fr</span>.
              </p>
            </div>
              ...
              <div className="text-[12px]">
                ...
                {sent === null && (
                  <div className="text-slate-500">
                    Envoi depuis Mindlink (réponse = ton email).
                  </div>
                )}
              </div>
